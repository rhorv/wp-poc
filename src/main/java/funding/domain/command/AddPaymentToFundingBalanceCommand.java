package funding.domain.command;
...
public class AddPaymentToFundingBalanceCommand extends Command implements IMessage {

  public static final String NAME = "add_payment_to_funding_balance";
  private UUID id;
  ...
  public AddPaymentToFundingBalanceCommand(UUID id, UUID merchantId, Money charges) {
    this.id = id;
  ...
  public static AddPaymentToFundingBalanceCommand fromMessage(IMessage message) {
    if (!message.getName().matches(AddPaymentToFundingBalanceCommand.NAME)) {
    ...
    return new AddPaymentToFundingBalanceCommand(
